...
export default function CartPage() {
    ...
    const totalPayment = subTotal + ADMIN_FEE;
        ...
        <div className="min-h-screen bg-white pb-28 flex flex-col">
            ...
            <div className="relative z-10 -mt-6 sm:-mt-8 rounded-t-2xl bg-white flex-1">
                <div className="p-4 sm:p-6 max-w-3xl mx-auto w-full">
                    <h2 className="text-lg sm:text-xl font-bold mb-4 text-center">Pesanan kamu!</h2>
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            {DELIVERY_OPTIONS.map((opt) => (
                                <label key={opt.value} className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    <span className={`font-semibold ${deliveryMethod === opt.value ? "text-black" : "text-gray-500"}`}>
                                        {opt.label}
                                    </span>
                                </label>
                            ))}
                    ...
                    <div className="space-y-1.5 text-sm sm:text-base">
                        ...
                        <div className="flex justify-between text-gray-600">
                            <p>Biaya Admin</p>
                            <p>Rp {ADMIN_FEE.toLocaleString("id-ID")}</p>
                        </div>
